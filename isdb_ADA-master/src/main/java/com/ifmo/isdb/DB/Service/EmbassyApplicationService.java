...
@Transactional
@Repository
public class EmbassyApplicationService {
    @Autowired
    ApplicationsRepo applicationsRepo;
    public ArrayList<Application> getApplicationsForEmbassy(String race){
        return  applicationsRepo.getApplicationsForEmbassy(race);
    }
